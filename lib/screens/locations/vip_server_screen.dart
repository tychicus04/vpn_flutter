...
import 'package:eye_vpn_lite/utils/colors/app_colors.dart';
...
class _VipServerScreenState extends State<VipServerScreen> {
  ...
  Widget build(BuildContext context) {
    return ListView(
      children: [
        Obx(() => vipServerController.isLoading.value?
            ...
            for (var server in vipServerController.vipServers)
              Padding(
                ...
                child: Card(
                  ...
                  color: Pref.isDarkMode?Color(0xff1E1E1E):Colors.white.withOpacity(0.9),
                  child: ListTile(
                    ...
                    ClipRRect(
                      ...
                      child: Image.memory(
                        Uint8List.fromList(Base64Decoder().convert(server.image.split(',').last)),
                        height:  40.h,
                        width:  50.w,
                        fit: BoxFit.cover,
                      ),
                    ...
                    trailing: Row(
                      ...
                      children: [
                        SizedBox(width: 4),
                        Icon(CupertinoIcons.location_solid, color: AppColors.appBlueColor),
                      ],
                    ),
                  ),
                ),
