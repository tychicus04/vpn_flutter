...
class _OnBoardState extends State<OnBoard> {
  ...
  final List<Widget> _pages = [
    const SliderScreen(
        description: "Eye vpn lite provide fastest vpn server free forever",
        image: "assets/lottie/welcome.json"),
    const SliderScreen(
        description: "Select a location and get connected within a single tap",
        image: "assets/lottie/explore.json"),
    const SliderScreen(
        description: "Let's enjoy any content all over the world and secure connection",
